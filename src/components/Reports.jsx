...
//       setIsLoading(true);
//       setError(null);
//       const response = await getAllConsultations(1, 100); // fetch all, paginate client-side
...
const Reports = () => {
  ...
  const currentRecords = filteredReports.slice(0, visibleCount);
    ...
    <div className="reports-container">
      <div className="reports-header">
        <div>
          <h2>Consultation Reports</h2>
          <p className="report-count">
            Showing {currentRecords.length} of {filteredReports.length} records
            {(fromDate || toDate || searchTerm) && ' (filtered)'}
          </p>
        </div>
        <div className="action-buttons">
          ...
          <div className="search-input-container">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setVisibleCount(15); // Reset visible count when search changes
              }}
              className="search-input"
            />
            {searchTerm && (
